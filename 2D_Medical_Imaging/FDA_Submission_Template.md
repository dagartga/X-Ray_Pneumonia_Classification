...
When these comorbidities are present it significantly affects the Recall and F1 score of the model at 0.3 threshold.
    ...
    Recall: 0.18
    F1 Score: 0.30
![F1 Comorbidities](./images/F1_Comorbidities.png)

![Recall Comorbidities](./images/Recall_Comorbidities.png)
...
![Precision and Recall vs Threshold](./images/Model_Stats.png)
...
![X-Ray Image Examples](./images/X-Ray_Images.png)
